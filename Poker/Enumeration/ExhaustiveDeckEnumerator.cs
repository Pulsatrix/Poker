...
namespace Poker.Enumeration
{
    ...
    /// </summary>
    public sealed class ExhaustiveDeckEnumerator : IEnumerator<CardMask>
    {
        ...
        public ExhaustiveDeckEnumerator(IDeck deck, int cardsToEnumerate, CardMask deadCardMask)
        {
            if (deck == null)
            {
